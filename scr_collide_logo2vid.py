...
video_filename = output_video_file
...
# Load all logo images from the 'logos' directory - suggest 64x64
logo_dir = 'logos'
...
# Release video writer outside the loop
